...
<figure><img src="../images/ghcp-01.png" alt="VS Code Copilot Chat 모델 선택기에서 톱니 아이콘으로 Manage Models 진입"><figcaption>모델 선택기 → 톱니(⚙) → Manage Models</figcaption></figure>
...
<figure><img src="../images/ghcp-02.png" alt="Manage Models에서 공급자로 Custom Endpoint를 선택하는 화면"><figcaption>Add Models → 공급자 Custom Endpoint 선택</figcaption></figure>
...
|---|---|
| <img src="../images/sub-agents-vscode-01.png" alt="VS Code Copilot Chat에서 APIM custom endpoint 모델을 사용하는 화면"> | <img src="../images/sub-agents-vscode-02.png" alt="VS Code Copilot Chat에서 subagent 모델 호출을 확인하는 화면"> |
