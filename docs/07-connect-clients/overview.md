---
description: 개발자·AI 도구 사용자를 위한 페이지 · 선행: 05-verify/smoke-test.md
---
...
[VS Code BYOK](vscode.md)
{% endcontent-ref %}

{% content-ref url="copilot-cli.md" %}
[GHCP CLI](copilot-cli.md)
{% endcontent-ref %}
...
{% content-ref url="direct-call.md" %}
[직접 호출 (curl)](direct-call.md)
{% endcontent-ref %}
