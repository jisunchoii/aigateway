...
<figure><img src=".gitbook/assets/diagram-greenfield-vs-brownfield.svg" alt="Greenfield 신규 생성과 Brownfield 기존 계정 재사용 의사결정 플로우"><figcaption><p>Greenfield는 계정과 모델을 새로 만들고, Brownfield는 기존 계정을 읽기 전용으로 참조한 뒤 Private Endpoint와 RBAC만 추가합니다.</p></figcaption></figure>
