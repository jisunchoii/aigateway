...
<figure><img src="../images/diagram-reuse-topology.png" alt="재사용 토폴로지 — 기존 Foundry 계정에 게이트웨이 VNet의 새 Private Endpoint를 연결"><figcaption>🖼️ 재사용 토폴로지 — 기존 Foundry 계정에 게이트웨이 VNet의 새 Private Endpoint를 연결 <em>(다이어그램 이미지 추가 예정)</em></figcaption></figure>
