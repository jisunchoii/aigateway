...
<div style="display:flex; align-items:stretch; gap:10px; font-family:'Segoe UI','Noto Sans KR',sans-serif; margin:16px 0;">
  <div style="flex:1; background:#F4F6FA; border-left:4px solid #556677; border-radius:4px; padding:14px;">
    <div style="font-size:11px; letter-spacing:1px; color:#556677; font-weight:700;">기존 (Before)</div>
    <div style="font-size:15px; font-weight:700; color:#0a2540; margin:6px 0;">기존 Foundry 계정</div>
    <div style="font-size:12.5px; color:#1a1a2e; line-height:1.8;">▸ 기존 구독 내 AIServices 계정<br>▸ 모델 배포 그대로 유지<br>▸ 게이트웨이와 무관하게 독립 운영<br>▸ 기존 VNet / RG</div>
  </div>
  <div style="display:flex; align-items:center; color:#556677; font-weight:700; font-size:12px; text-align:center; padding:0 4px;">격리<br>↕<br>변경 없음</div>
  <div style="flex:1.3; background:#0a2540; border-radius:4px; padding:14px; color:#fff;">
    <div style="font-size:11px; letter-spacing:1px; color:#5AC8FA; font-weight:700;">게이트웨이 (After)</div>
    <div style="font-size:15px; font-weight:700; margin:6px 0;">게이트웨이 전용 VNet</div>
    <div style="font-size:12.5px; color:#dce6f0; line-height:1.8;">▸ APIM 인스턴스<br>▸ Managed Identity<br><span style="color:#FFB454;">⊕</span> <span style="color:#6EE7B7; font-weight:700;">신규 Private Endpoint</span> → 기존 계정<br><span style="color:#FFB454;">⊕</span> <span style="color:#6EE7B7; font-weight:700;">신규 RBAC 역할 부여</span></div>
  </div>
  <div style="display:flex; align-items:center; color:#107C41; font-weight:700; font-size:11px; text-align:center; padding:0 4px;">PE만<br>신규<br>▶</div>
  <div style="flex:1; background:#EEF7F0; border-left:4px solid #107C41; border-radius:4px; padding:14px;">
    <div style="font-size:11px; letter-spacing:1px; color:#107C41; font-weight:700;">연결 결과</div>
    <div style="font-size:15px; font-weight:700; color:#0a2540; margin:6px 0;">Foundry 계정 (무수정)</div>
    <div style="font-size:12.5px; color:#1a1a2e; line-height:1.8;">✓ 계정 속성 변경 없음<br>✓ 모델 배포 그대로<br>✓ Private Endpoint 경유<br>✓ 키 인증 off (사전 작업)</div>
  </div>
</div>
<!-- /diagram -->
