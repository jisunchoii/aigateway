...
그린필드 배포 시 사용하는 나머지 변수(`prefix`, `location`, `owner` 등)는 [03-deploy/configure-tfvars.md](../03-deploy/configure-tfvars.md)를 참고합니다.
...
tfvars 편집을 마쳤으면 [plan & apply](plan-and-apply.md)로 넘어갑니다.
